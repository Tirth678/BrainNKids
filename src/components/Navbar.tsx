...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gray-900 shadow-lg fixed w-full z-50 border-b border-gray-800">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <a href="#courses" className="text-gray-300 hover:text-purple-400">Courses</a>
        ...
        {isOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <a href="#courses" className="block px-3 py-2 text-gray-300 hover:text-purple-400">
                Courses
              </a>
              <a href="#about" className="block px-3 py-2 text-gray-300 hover:text-purple-400">
                About
              </a>
